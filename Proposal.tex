...
\textcolor{red}{In this section we describe the architecture and functioning of our proposed user-driven and context-aware Recommendation System. Figure XX shows its components: (XX HACER UNA figura con la arquitectura, si es posible en función de los tres módulo de un SR...y en cada módulo pones lo que corresponda, la red semántica, spreding, aging, la ontología, etc.) } 
...
\textcolor{red}{Ya todo lo tienes redactado, sólo hay que organizarlo mejor. Que la redacción sea más fluida}
